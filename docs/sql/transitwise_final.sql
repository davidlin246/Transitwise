...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2024 at 02:55 AM
...
CREATE TABLE `tickets` (
  ...
  `frequent_flyer` int(22) NOT NULL,
...
--
ALTER TABLE `reservations`
  MODIFY `RSID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `timecard`
  MODIFY `TCID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `users`
  MODIFY `UPID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `employees`
  ADD CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`UPEID`) REFERENCES `permissions` (`UPEID`);

--
-- Constraints for table `feedback`
--
ALTER TABLE `feedback`
  ADD CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`UPID`) REFERENCES `users` (`UPID`);
